...
$url='stock price database/daily reports/2014-2015-DAILY-REPORT-ORACLE.xls';
$excel->read($url);
...
$value4=$value4;
$opening_next = $value4;
$_SESSION['oraclen']=$final=$opening_next[0] - $closing_price[0];
  ...
  <body>
          ...
          <div class="box box-success">
              <div class="box-header with-border">
                   <h3 class="box-title">COMPANY ORACLE</h3><br>
